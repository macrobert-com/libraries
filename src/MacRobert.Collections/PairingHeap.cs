namespace MacRobert.Collections;
...
public class PairingHeap<T>
{
    ...
    public PairingHeap(Func<T, T, bool> compareFn)
        : this(null, compareFn, defaultFactory)
    { }

    public PairingHeap(IEnumerable<T> items)
    : this(items, (IComparer<T>)null, defaultFactory)
    { }
